...
BigEnemy::BigEnemy(std::shared_ptr<Models> model, std::shared_ptr<Shaders> shader, std::shared_ptr<Texture> texture, GLint numFrames, GLfloat frameTime)
...
void BigEnemy::Move(GLfloat deltatime)
{
